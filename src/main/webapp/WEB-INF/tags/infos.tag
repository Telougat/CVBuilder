...
<p:pageWithHeader>
    <jsp:body>
        <div class="w-full min-h-screen relative">
            <component:bg_blue/>
            <div class="lg:flex">
                <div class="flex justify-center transform -translate-y-1/2 lg:translate-x-16">
                    <img class="w-32 lg:w-40" src="${pageContext.request.contextPath}/resources/images/cv.svg" alt="CV">
                </div>
                <div class="w-full lg:w-1/2 lg:transform lg:translate-x-48 lg:-translate-y-16">
